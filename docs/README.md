...
6. [Kontrak Integrasi Keluaran AI v0.1](./ai-software-integration-contract-v0.1.md) —
   **BERLAKU UNTUK INTEGRASI SOFTWARE.**
   Menjelaskan payload minimum kelas risiko AI, keadaan LIVE tanpa model,
   simulasi `TEST_ONLY`, pemisahan status LIG/keterisian/kualitas sensor, dan
   daftar `MUST FIX` untuk backend, aplikasi, serta web. JSON Schema dan contoh
   payload berada di `ai/contracts/`.
